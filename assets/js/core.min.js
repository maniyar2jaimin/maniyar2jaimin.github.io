...
var Mi = {
    ...
    Basic: {
        ...
        ajaxLoader: function() {
            ...
            var o, i, n = $("#ajax-loader"), r = $("#ajax-modal"), s = !1;
        ...
        forms: function() {
            ...
            o.submit(function() {
                ...
                o.valid() ? ($.ajax({
                    ...
                    data: $(this).serialize(),
                    success: function(t) {
                        a = "SEND" === t ? '<div class="alert alert-success">Done! Thank you for your message - You will get an answer as soon as possible.' : '<div class="alert alert-danger">Ooops... It seems that we have a problem.',
                        e.html(a),
                        e.show()
                    }
                }),
    ...
    Components: {
        ...
        videoPlayer: function() {
            var e = $(".video-player");
            e && e.YTPlayer(),
            trueMobile && e.hasClass("bg-video") && (e.prev(".bg-video-placeholder").show(),
            e.remove())
        },
        messenger: function() {
            $('[data-target="messenger"]').on("click", function() {
                var e = $("#messenger")
                  , t = $("#messenger-box");
                return e.hasClass("active") ? (t.find(".messenger-box-content").fadeOut(),
